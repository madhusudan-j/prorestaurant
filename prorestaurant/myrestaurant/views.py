...
from myrestaurant.models import RestaurantReview, Restaurant, Dish
...
class LoginRequiredCheckIsOwnerUpdateView(LoginRequiredMixin, CheckIsOwnerMixin, UpdateView):
    template_name = 'myrestaurant/form.html'

# HTML Views

class RestaurantDetail(DetailView):
    model = Restaurant
    template_name = 'myrestaurant/restaurant_detail.html'
...
def review(request, pk):
    ...
    new_review.save()
    return HttpResponseRedirect(reverse('myrestaurant:restaurant_detail', args=(restaurant.id,)))